package wastedge.api.weql.generator.syntax;

import wastedge.api.weql.generator.CodeWriter;
import wastedge.api.weql.generator.syntax.xml.SyntaxClass;
import wastedge.api.weql.generator.syntax.xml.SyntaxProperty;
import wastedge.api.weql.generator.syntax.xml.SyntaxSchema;
...
public class GenerateSyntax {
    ...
    private void generateClass(File outputDirectory, SyntaxClass schemaClass, String packageName) throws IOException {
        ...
        cw.writeln("import wastedge.api.weql.*;");
        cw.writeln("import wastedge.api.weql.syntax.*;");
