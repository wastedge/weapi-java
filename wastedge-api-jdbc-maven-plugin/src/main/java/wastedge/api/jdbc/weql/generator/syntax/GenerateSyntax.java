package wastedge.api.jdbc.weql.generator.syntax;

import wastedge.api.jdbc.weql.generator.CodeWriter;
import wastedge.api.jdbc.weql.generator.syntax.xml.SyntaxClass;
import wastedge.api.jdbc.weql.generator.syntax.xml.SyntaxProperty;
import wastedge.api.jdbc.weql.generator.syntax.xml.SyntaxSchema;
...
public class GenerateSyntax {
    ...
    private void generateClass(File outputDirectory, SyntaxClass schemaClass, String packageName) throws IOException {
        ...
        cw.writeln("import wastedge.api.jdbc.weql.*;");
        cw.writeln("import wastedge.api.jdbc.weql.syntax.*;");
