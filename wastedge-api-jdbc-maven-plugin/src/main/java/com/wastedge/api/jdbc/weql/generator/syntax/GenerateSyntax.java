package com.wastedge.api.jdbc.weql.generator.syntax;

import com.wastedge.api.jdbc.weql.generator.CodeWriter;
import com.wastedge.api.jdbc.weql.generator.syntax.xml.SyntaxClass;
import com.wastedge.api.jdbc.weql.generator.syntax.xml.SyntaxProperty;
import com.wastedge.api.jdbc.weql.generator.syntax.xml.SyntaxSchema;
...
public class GenerateSyntax {
    ...
    private final Set<String> builtInNames = new HashSet<>(Arrays.asList(
        "else"
    ));
    ...
    private void generateClass(File outputDirectory, SyntaxClass schemaClass, String packageName) throws IOException {
        ...
        cw.writeln("import com.wastedge.api.jdbc.weql.*;");
        cw.writeln("import com.wastedge.api.jdbc.weql.syntax.*;");
        cw.writeln("import org.apache.commons.lang3.Validate;");
        cw.writeln();
        cw.writeln("import java.util.List;");
        cw.writeln();
